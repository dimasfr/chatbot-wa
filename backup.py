...
conn = mysql.connector.connect(
	...
	user="root",
	passwd="",
	database="project_nilai"
)
mycursor = conn.cursor()


# Define XPATH
xpath_unread_msg = "//*[@class='_2UaNq _2ko65']"
xpath_user_name = "//*[@class='_19vo_']//*[@class='_19RFN _1ovWX _F7Vk']"
...
kernel = aiml.Kernel()
try:
	if os.path.isfile("brain/DiraBrain.brn"):
	    kernel.bootstrap(brainFile = "brain/DiraBrain.brn")
	else:
		...
		kernel.saveBrain("brain/DiraBrain.brn")
...
def main(): #Program utama - main
	...
	while True:
		...
		# If Start : Detecting Unread Message in Panel Side then Chat with it
		...
		# If End
		# Else Start : Chatting with the Opened Chat Windows
		else:
			try:
				url = driver.page_source
				soup = bs(url, "lxml")
